...
function Footer() {
  return (
    <footer className="bg-pink-500 text-white p-6 shadow-md">
      <div className="container mx-auto grid grid-cols-1 max-w-7xl md:grid-cols-4 gap-8 py-16">
        <div className="md:col-span-2"> 
          <h2 className='text-4xl'>Yamba</h2>
        ...
        <div>
          ...
          <a href="mailto:yambaonline@gmail.com" className="text-white">Contact us at yambaonline@gmail.com</a>
        </div>
        <div>
          <h4 className="text-lg font-bold mb-2">Follow Us</h4>
          <div className="flex space-x-4">
            <a href="https://facebook.com/" className="hover:text-pink-200"><FaFacebook /></a>
            <a href="https://x.com/yambaonthenet" className="hover:text-pink-200"><FaTwitter /></a>
            <a href="https://instagram.com/yambaonthenet" className="hover:text-pink-200"><FaInstagram /></a>
          </div>
        </div>
      </div>
      <div className="text-center mt-8 border-t border-white pt-4">
        <p>&copy; {new Date().getFullYear()} Yamba. All rights reserved.</p>
      </div>
    </footer>
  );
}
